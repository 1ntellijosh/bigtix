/**
 * Checks the incoming event message for idempotency, and if it is not already processed, runs the handler and marks it as
 * processed.
 *
 * @since event-bus-idempotency--JP
 */
import { EventEnvelope } from './contracts/EventContracts';
import { AbstractProcessedEventRepository } from './contracts/AbstractProcessedEventRepository';
