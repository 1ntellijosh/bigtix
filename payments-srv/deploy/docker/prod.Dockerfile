# ------------------------------------------------------------------------------------------------
# PRODUCTION Dockerfile for Payments microservice of BigTix platform E-Commerce project
...
# ------------------------------------------------------------------------------------------------
    ...
    # Copy payments-srv package.json and point workspace deps to local packages
    ...
    # Copy payments-srv source and build for production
